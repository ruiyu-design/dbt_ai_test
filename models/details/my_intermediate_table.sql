...
AND signup_date>='2024-11-20' -- 【修正】将年份改为 2024 以确有数据
-- AND signup_date<='2025-11-12' 
...
SELECT
 ...
 ,count(distinct CASE WHEN is_trial=1 THEN uid ELSE NULL END) AS trial_users -- [TEST v4] 试用用户：统计在注册后 24 小时内开启 Trial 权限的去重用户数
